...
let weeks = "for a while, but also never enough"
let masterStatus = false;

// Which variables need to be created?
// What type of data needs to go in each variable?

console.log ("Hello, my name is " + myName + ", and I am learning " + language + ". I've been practicing " + weeks + ",so my status as a master is" + masterStatus + ".");
